...
<head>
  ...
  <title>カート</title>
  <link rel="stylesheet" href="<?php hprint(STYLESHEET_PATH . 'cart.css'); ?>">
</head>
<body>
          ...
          <tr>
            ...
            <td>
              <form method="post" action="cart_change_amount.php">
                <input type="number" name="amount" value="<?php hprint($cart['amount']); ?>">
                個
                <input type="submit" value="変更" class="btn btn-secondary">
                <input type="hidden" name="cart_id" value="<?php hprint($cart['cart_id']); ?>">
